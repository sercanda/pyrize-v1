             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 print:gap-12">
                <div className="flex flex-col justify-center">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 leading-tight print:text-black">
                        Büyükkolpınar'da <br/> <span className="text-slate-500 italic font-serif print:text-slate-800">Lüks Yaşam.</span>
                    </h2>
                    <div className="space-y-6 mb-8">
                        <p className="text-slate-300 text-lg font-light leading-relaxed print:text-black">
                            {property.marketAnalysis.microLocationValue} 43 m² salonu ve 30 m² balkonu ile standartların çok ötesinde.
                        </p>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                         ...
                         <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-300 mt-1 print:text-black">Ayçil Tower gibi marka projeler, piyasa dalgalanmalarında değerini koruyan "Güvenli Liman" niteliğindedir.</p>
                            </div>
                        </div>
                    </div>
                 </div>
