        ...
        <div className="relative overflow-hidden rounded-3xl bg-indigo-600 px-6 py-16 shadow-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left relative z-10">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                    <a href="tel:+905551234567" className="rounded-full bg-white px-8 py-3.5 text-sm font-bold text-indigo-600 shadow-sm hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-all hover:scale-105">
                        Hemen Arayın: +90 555 123 45 67
                    </a>
                </div>
