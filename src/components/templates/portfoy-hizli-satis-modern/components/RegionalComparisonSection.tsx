  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-gray-900/80 backdrop-blur-sm p-4 rounded-lg border border-gray-600">
        <p className="label text-indigo-400 font-bold">{`${label}`}</p>
        {payload.map((pld: any) => (
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold text-white">
            Veriye Dayalı <span className="text-indigo-400">Piyasa Analizi</span>
          </h2>
          ...
          {regionalData.kfeMetrics && (
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm">
              <div className="bg-indigo-500/10 border border-indigo-500/30 rounded-lg px-4 py-2">
                <span className="text-indigo-300 font-semibold">Bölge Yıllık Artış: </span>
