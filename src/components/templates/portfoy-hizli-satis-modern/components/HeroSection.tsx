  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ 
            backgroundImage: `url(https://images.unsplash.com/photo-1600596542815-e328d4de4bf7?q=80&w=2000&auto=format&fit=crop)`, 
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-2xl font-light text-slate-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          Veriye dayalı analiz, modern pazarlama ve sonuç odaklı strateji ile gayrimenkulünüzün gerçek potansiyelini ortaya çıkarıyoruz.
        </p>
