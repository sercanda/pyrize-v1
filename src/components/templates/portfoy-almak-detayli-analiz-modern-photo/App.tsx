        ...
        <main className="flex flex-col gap-24 print:gap-0">
            ...
            <div className="min-h-screen flex flex-col print:block print:h-auto print:break-after-page print:px-8 print:py-8 relative">
                ...
                <div className="flex-1 flex flex-col justify-center gap-12 px-6 md:px-12 lg:px-16 print:px-0 print:gap-8 print:block">
                    ...
                    <HeroSection 
                      images={{
                        main: PROPERTY_DATA.gorselUrl || "https://images.unsplash.com/photo-1560518883-ce09059ee41f?q=80&w=1973&auto=format&fit=crop",
                        view: PROPERTY_DATA.gorselUrl || "https://images.unsplash.com/photo-1560518883-ce09059ee41f?q=80&w=1973&auto=format&fit=crop",
                        pool: PROPERTY_DATA.gorselUrl || "https://images.unsplash.com/photo-1560518883-ce09059ee41f?q=80&w=1973&auto=format&fit=crop",
                        sign: PROPERTY_DATA.gorselUrl || "https://images.unsplash.com/photo-1560518883-ce09059ee41f?q=80&w=1973&auto=format&fit=crop"
                      }}
                      title={PROPERTY_DATA.planBaslik || "Özel Analiz Raporu"}
                      subtitle={PROPERTY_DATA.planAltBaslik || ""}
                      description={PROPERTY_DATA.tanitimStratejisi?.anaMesaj || ""}
                      location={`${PROPERTY_DATA.konumAnalizi.ilIlce} / ${PROPERTY_DATA.konumAnalizi.mahalle}`}
                      consultantName={CONSULTANT_DATA.adSoyad || "Danışman Adı"}
                      propertyType={PROPERTY_DATA.konumAnalizi.mevcutYapi || "Daire"}
                      odaSayisi="4+1"
                      metrekare="215 m²"
                    />
            ...
            <PrintPageWrapper className="print:justify-start">
                ...
                <footer className="border-t border-white/5 py-8 flex flex-col items-center text-center bg-slate-950 mt-auto print:py-6 print:bg-transparent print:border-slate-300 print:mt-8">
                    ...
                    <div className="flex flex-col items-center gap-2 opacity-70 print:opacity-100">
                        ...
                        />
                        <a href="https://pyrize.com" target="_blank" rel="noopener noreferrer" className="text-[10px] font-semibold text-slate-600 tracking-wider print:text-slate-800">
                          pyrize.com
                        </a>
                    </div>
                </footer>
