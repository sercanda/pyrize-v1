...
export interface Consultant {
  ...
  ofisAdi: string;
  // Not: Formdan string olarak gelebilir, TemplateModernFromZip içinde diziye çevriliyor.
  // Diğer template'lerde de geriye dönük uyumluluk için string | string[] bırakıyoruz.
  oduller: string[] | string;
