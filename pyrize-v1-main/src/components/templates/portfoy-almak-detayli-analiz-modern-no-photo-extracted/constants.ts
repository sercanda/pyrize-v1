...
export const PROPERTY_DATA: Property = {
  presentation: {
    reportTitle: "Özel Satış Sunumu",
    dateRef: "Ekim 2023 • Ref: 1014",
    mainTitle: "AYÇİL",
    mainTitleHighlight: "TOWER",
    subTitle: "Satış Stratejisi & Piyasa Analizi",
    description: {
        location: "Büyükkolpınar Mahallesi",
        netArea: "195 m²",
        type: "4+1 Lüks Daire",
        text: "net kullanım alanına sahip, lüks daire için hazırlanmış kapsamlı piyasa analizi ve pazarlama planı."
    },
    stats: [
        { value: "195", unit: "m²", label: "Net Alan" },
        { value: "4+1", unit: "", label: "Daire Tipi" }
    ]
  },
